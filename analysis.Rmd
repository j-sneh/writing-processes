...
```
As we can see our cluster UMAP shows that while we do cluster pretty well, the seperation between the cluster is not very good. The data is not well clustered. For further analysis, here we see the distribution of scores in another UMAP
...
```{r}
# Confusion Matrix
kable(table(train.prop.pred_score, train.supervised$score), caption = "Training Propodds Confusion Matrix")
# Accuracy
...
# Confusion Matrix
kable(table(test.prop.pred_score, test.supervised$score), caption = "Testing Propodds Confusion Matrix")
# Accuracy
...
# Confusion Matrix
kable(table(knn.train.pred, train.supervised$score), caption = "Training KNN Confusion Matrix")
# Accuracy
mean(conv(knn.train.pred) == conv(train.supervised$score))
# MAE
mean(abs(conv(knn.train.pred) - conv(train.supervised$score)))
```
...
# Confusion Matrix
kable(table(knn.test.pred, test.supervised$score), caption = "Testing KNN Confusion Matrix")
# Accuracy
mean(conv(knn.test.pred) == conv(test.supervised$score))
# MAE
mean(abs(conv(knn.test.pred) - conv(test.supervised$score)))
```
...
# confusion matrix
kable(table(train.labeled_predictions, train.supervised$score), caption = "Training XGBoost Confusion Matrix")
# train accuracy
...
# confusion matrix
kable(table(test.labeled_predictions, test.supervised$score), caption = "Testing XGBoost Confusion Matrix")
