...
- Maok Yongsuk's Kaggle Submission: \href{https://www.kaggle.com/code/yongsukprasertsuk/writing-processes-to-quality-0-584}{\textcolor{purple!70!white}{Maok Yongsuk}}

- Other Submission: \href{https://www.kaggle.com/code/cody11null/lgbm-x2-nn}{\textcolor{purple!70!white}{Cody’s LGBM + NN}}

- Other Submission 2 (LGBM + NN): \href{https://www.kaggle.com/code/seoyunje/feature-1-lgb-nn-ridge}{\textcolor{purple!70!white}{Seoyunje’s LGBM + NN}}

- Research 1: \href{https://scikit-learn.org/stable/auto_examples/cluster/plot_kmeans_silhouette_analysis.html#:~:text=The%20silhouette%20plot%20displays%20a,like%20number%20of%20clusters%20visually.}{\textcolor{purple!70!white}{Research - Silhouette Plots}}

- Research 2: \href{https://towardsdatascience.com/implementing-and-interpreting-ordinal-logistic-regression-1ee699274cf5}{\textcolor{purple!70!white}{Ordinal Logistic Regression}}
...
Instead of looking at the predicted classification accuracy, we can look at the MAE. This will give us a better idea of how far off the predictions are. 
...
for (i in 1:nrow(eta_vals)) {
  model.xgb <- xgboost(data = as.matrix(train.supervised[, -1]), label = as.numeric(train.supervised$score) - 1, nrounds = 50, objective = "multi:softmax", 
